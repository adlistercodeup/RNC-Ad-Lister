...
<body>
	<div class="container">
		...
		<div id="already-member">
			        <!-- insert JS click listener -->
			<button id="member-submit" type="submit">Already a Member?</button>
		</div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="img/children-happy.png" alt="Chania" width="460" height="345">
      ...
      <div class="item">
        <img src="img/children-happy.png" alt="Flower" width="460" height="345">
        <div class="carousel-caption">
          <h3>Flowers</h3>
